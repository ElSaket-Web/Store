            ...
            if (
              ("Essential_Addons_Elementor\\Pro\\Elements\\Dynamic_Filterable_Gallery" ===
                ...
                (y = e(
                  ".elementor-element-" +
                    r +
                    " .dynamic-gallery-category.active"
                ).data("termid")),
                (_ = e(
                  ".elementor-element-" +
                    r +
                ...
                if (
                  ...
                  b.class
                    ? (t
                      ...
                      o.html(l),
                      t.parent().hasClass("eael-infinity-scroll") &&
                        t.parent().remove())
                    : "Essential_Addons_Elementor\\Pro\\Elements\\Dynamic_Filterable_Gallery" ==
                      b.class
                  ...
                  if (
                    ...
                    if (
                      ...
                      (d = e(".eael-product-grid .products", s).isotope())
                        ...
                        e(".woocommerce-product-gallery." + n, s).each(
                          function () {
                      ...
                      r.find(".woocommerce-product-gallery").addClass(i),
                        r
                          .find(".woocommerce-product-gallery")
                          .addClass("eael-new-product"),
                        e(".woocommerce-product-gallery." + i, s).each(
                          function () {
                            e(this).wc_product_gallery();
                          }
                        );
                    ...
                    e(".eael-post-appender", s).append(r);
                    var d,
                      c = e(".eael-post-appender", s).data("settings");
                    if ("masonry" == p || (null != c && c.has_filter))
                  ...
                  if (
                    ...
                    o.html(l),
                    "Essential_Addons_Elementor\\Elements\\Woo_Product_Gallery" ==
                      b.class && e(".eael-cat-tab li a.active", s).length
                    ...
                    var u = e(r[0]);
                    u.hasClass("found_posts") &&
                      u.text() - v.posts_per_page < 1 &&
                      S(t),
                      u.remove();
                  }
                }
  ...
  26: function (e, t) {
    ...
    var i = {
      quickViewAddMarkup: function (e, t) {
        t("body > .eael-woocommerce-popup-view").length ||
          t("body").prepend(
      ...
      openPopup: function (e, t) {
        jQuery(document).on("click", ".open-popup-link", function (e) {
          ...
          if (void 0 !== o) {
            var r = t(".eael-woocommerce-popup-view");
            r
              .find(".eael-popup-details-render")
              .html('<div class="eael-preloader"></div>'),
              r
              ...
              t.ajax({
                ...
                type: "post",
                data: n(
                  n({ action: "eael_product_quickview_popup" }, o),
                  {},
                  { security: localize.nonce }
                ),
                success: function (e) {
                  if (e.success) {
                    var n = t(e.data).children(".eael-product-popup-details");
                    n.find(".variations_form").wc_variation_form();
                    var a = r.find(".eael-popup-details-render");
                    r.find(".eael-popup-details-render").html(n);
                    var i = r.find(".woocommerce-product-gallery");
                    a.addClass("elementor-" + o.page_id),
                      a
                        .children()
                        .addClass(
                          "elementor-element elementor-element-" + o.widget_id
                        ),
                      n.height() > 400
                        ? n.css("height", "75vh")
                        : n.css("height", "auto"),
                      setTimeout(function () {
                        var e = i
                          ...
                          .height();
                        t("body").prepend(
                          '<style class="eael-quick-view-dynamic-css">.woocommerce-product-gallery .flex-viewport { height: ' +
                            e +
                            "px; }</style>"
                        ),
                          i.wc_product_gallery(),
                          i
                            .closest(".eael-product-image-wrap")
                            .css("background", "none");
                      }, 500),
                      setTimeout(function () {
      ...
      closePopup: function (e, t) {
        t(document).on("click", ".eael-product-popup-close", function (e) {
          ...
          t(document).on("click", function (e) {
            e.target.closest(".eael-product-popup-details") ||
              i.remove_product_popup(t);
          });
      },
            ...
            var o = t(this),
              ...
              n =
                o
                  ...
                  .val() || "",
              a = o.closest("form.cart").find('input[name="quantity"]').val(),
              i = o.closest("form.cart.grouped_form"),
              c = o.closest("form.cart"),
              u = [];
            (i = i.serializeArray()),
              c.hasClass("variations_form") &&
                (r = c.find('input[name="product_id"]').val()),
              i.length > 0
                ? i.forEach(function (e, t) {
                    var o = parseInt(e.name.replace(/[^\d.]/g, ""), 10);
                    e.name.indexOf("quantity[") >= 0 &&
                      "" != e.value &&
                      o > 0 &&
                      (u[u.length] = {
                        product_id: o,
                ...
                : (u[0] = { product_id: r, quantity: a, variation_id: n }),
              o.removeClass("eael-addtocart-added"),
              o.addClass("eael-addtocart-loading"),
              t.ajax({
                url: localize.ajaxurl,
                type: "post",
                data: {
                ...
                success: function (e) {
                  e.success &&
                    ...
                    o.removeClass("eael-addtocart-loading"),
                    o.addClass("eael-addtocart-added"),
                    "yes" == localize.cart_redirectition &&
      ...
      remove_product_popup: function (e) {
        ...
        t
          ...
          t.find(".eael-popup-details-render").html("");
      },
    };
    jQuery(document).on("click", ".yith-wcan-filters", function () {
      window.forceFullyRun = !0;
    }),
      (eael.elementStatusCheck("eaelQuickView") &&
        void 0 === window.forceFullyRun) ||
        (eael.hooks.addAction(
          "quickViewAddMarkup",
          "ea",
          i.quickViewAddMarkup,
          10
        ),
        eael.hooks.addAction("quickViewPopupViewInit", "ea", i.openPopup, 10),
        eael.hooks.addAction("quickViewPopupViewInit", "ea", i.closePopup, 10),
        eael.hooks.addAction(
          "quickViewPopupViewInit",
          "ea",
          i.singlePageAddToCartButton,
          10
        ),
        eael.hooks.addAction(
          "quickViewPopupViewInit",
          "ea",
          i.preventStringInNumberField,
          10
        ));
  },
});
!(function (e) {
  ...
  24: function (e, t) {
    eael.hooks.addAction("init", "ea", function () {
      (eael.elementStatusCheck("eaelProductGridLoad") &&
        void 0 === window.forceFullyRun) ||
        elementorFrontend.hooks.addAction(
          "frontend/element_ready/eicon-woocommerce.default",
          function (e, t) {
            eael.hooks.doAction("quickViewAddMarkup", e, t);
            var a = e.find("#eael-product-grid"),
              o = a.data("widget-id"),
              r = a.data("page-id"),
              i = a.data("nonce"),
              c = document.createElement("div");
            c.classList.add("wcpc-overlay"),
              c.setAttribute("id", "wcpc-overlay");
            var d = document.getElementsByTagName("body")[0];
            d.appendChild(c);
            var n = document.getElementById("wcpc-overlay"),
              l = t(document),
              s = !1,
              p = !1,
              u = !1,
            ...
            var v = t("#eael_modal_content"),
              g = document.getElementsByClassName("eael-wcpc-modal")[0],
              y = [
                { name: "action", value: "eael_product_grid" },
                { name: "widget_id", value: o },
                { name: "page_id", value: r },
                { name: "nonce", value: i },
              ],
              h = function (e, a, o, r, i) {
                t.ajax({
                  url: localize.ajaxurl,
                  type: "POST",
                  dataType: "json",
            ...
            function w(e) {
              e &&
                ...
                localStorage.setItem(
                  "productIds",
                  JSON.stringify(e.data.product_ids)
                )),
                s && s.hide(),
                "compare" === f &&
                  (m && m.length
                    ? m.text(localize.i18n.added)
                    : u && p.html('<i class="fas fa-check-circle"></i>')),
                "remove" === f &&
                  (m && m.length
                    ? m.text(localize.i18n.compare)
                    : u && p.html('<i class="fas fa-exchange-alt"></i>'));
            }
            function b(e, t) {
              console.log(t.toString());
            }
            a.hasClass("masonry") &&
              l.ajaxComplete(function () {
                t(window).trigger("resize");
              }),
              l.on("click", ".eael-wc-compare", function (e) {
                e.preventDefault(),
                  e.stopImmediatePropagation(),
                  (f = "compare"),
                  (p = t(this)),
                  (m = p.find(".eael-wc-compare-text")).length ||
                    (u = p.hasClass("eael-wc-compare-icon")),
                  u || (s = p.find(".eael-wc-compare-loader")).show();
                var a = p.data("product-id"),
                  o = localStorage.getItem("productIds");
                o ? (o = JSON.parse(o)).push(a) : (o = [a]),
                  y.push({ name: "product_id", value: p.data("product-id") }),
                  y.push({ name: "product_ids", value: JSON.stringify(o) }),
                  h(y, w, b);
              }),
              l.on("click", ".close-modal", function (e) {
                (g.style.visibility = "hidden"),
                  (g.style.opacity = "0"),
                  (n.style.visibility = "hidden"),
                  (n.style.opacity = "0");
              }),
              l.on("click", ".eael-wc-remove", function (e) {
                e.preventDefault(), e.stopImmediatePropagation();
                var a = t(this),
                  o = a.data("product-id");
                a.addClass("disable"), a.prop("disabled", !0);
                var r = localStorage.getItem("productIds");
                r ? (r = JSON.parse(r)).push(o) : (r = [o]);
                var i = Array.from(y);
                i.push({ name: "product_id", value: o }),
                  i.push({ name: "remove_product", value: 1 }),
                  i.push({ name: "product_ids", value: JSON.stringify(r) }),
                  (f = "remove");
                var c = t('button[data-product-id="' + o + '"]');
                (m = c.find(".eael-wc-compare-text")).length ||
                  (u = c.hasClass("eael-wc-compare-icon")),
                  h(i, w, b);
              }),
              t(".eael-woo-pagination", e).on("click", "a", function (e) {
                e.preventDefault();
                var a = t(this),
                  o = a.closest(".eael-woo-pagination"),
                  r = a.data("pnumber"),
                  i = o.data("plimit"),
                  c = localize.ajaxurl,
                  d = o.data("args"),
                ...
                t.ajax({
                  ...
                  beforeSend: function () {
                    t(s).addClass("eael-product-loader");
                  },
                  success: function (e) {
                    t(s + " .eael-product-grid .products").html(e),
                      t(s + " .woocommerce-product-gallery").each(function () {
                        t(this).wc_product_gallery();
                      }),
                      t("html, body").animate(
                        {
                          scrollTop:
                            t(s + " .eael-product-grid").offset().top - 50,
                        },
                        500
                      );
                  },
                  complete: function () {
                    t(s).removeClass("eael-product-loader");
                  },
                }),
                  t.ajax({
                    url: c,
                    ...
                    success: function (e) {
                      t(s + " .eael-product-grid .eael-woo-pagination").html(e),
                        t("html, body").animate(
                          {
                            scrollTop:
                              t(s + " .eael-product-grid").offset().top - 50,
              ...
              eael.hooks.doAction("quickViewPopupViewInit", e, t),
              isEditMode &&
                t(".eael-product-image-wrap .woocommerce-product-gallery").css(
                  "opacity",
                  "1"
                ),
              t(document).find(".eael-woocommerce-popup-view").length < 1 &&
                t("body").append(
                  '<div style="display: none" class="eael-woocommerce-popup-view eael-product-popup eael-product-zoom-in woocommerce">\n                    <div class="eael-product-modal-bg"></div>\n                    <div class="eael-popup-details-render eael-woo-slider-popup"><div class="eael-preloader"></div></div>\n                </div>'
                );
            var _ = (dataSrcHover = srcset = srcsetHover = "");
            t(document)
              .on("mouseover", ".eael-product-wrap", function () {
                var a = t("body").attr("data-elementor-device-mode");
                "yes" ===
                  e
                    .find(".products.eael-post-appender")
                    .attr("data-ssi-" + a) &&
                  ((_ = t(this).data("src")),
                  (dataSrcHover = t(this).data("src-hover")),
                  (srcset = t(this).find("img").attr("srcset")),
                  dataSrcHover &&
                    (t(this).find("img").attr("srcset-hover", srcset),
                    t(this).find("img").attr("src", dataSrcHover),
                    t(this).find("img").attr("srcset", dataSrcHover)));
              })
              .on("mouseout", ".eael-product-wrap", function () {
                ...
                "yes" ===
                  ...
                  ((_ = t(this).data("src")),
                  (dataSrcHover = t(this).data("src-hover")),
                  (srcsetHover = t(this).find("img").attr("srcset-hover")),
                  dataSrcHover &&
                    (t(this).find("img").attr("src", _),
                    t(this).find("img").attr("srcset", srcsetHover),
                    t(this).find("img").attr("srcset-hover", "")));
              });
          }
        );
    });
