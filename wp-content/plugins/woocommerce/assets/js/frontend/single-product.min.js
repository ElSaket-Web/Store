    ...
    .on("keydown", ".wc-tabs li a, ul.tabs li a", function (e) {
      ...
      if ([a, r, n, s, c, l].includes(o)) {
        ...
        if (p.length >= 2) {
          ...
          m =
            Math.abs(f.top - _.top) > Math.abs(f.left - _.left)
              ? "vertical"
              : "horizontal";
        }
        ("vertical" !== m || (o !== r && o !== a)) &&
          ("horizontal" !== m || (o !== s && o !== n)) &&
          (e.preventDefault(),
          (o === r && 0 === g && "horizontal" === m) ||
          (o === s && 0 === g && "vertical" === m) ||
          o === c
            ? (u = h)
            : ((a === o && g === h && "horizontal" === m) ||
                (n === o && g === h && "vertical" === m) ||
                o === l) &&
              (u = 0),
          p.eq(u).focus());
  ...
  (e.prototype.initFlexslider = function (e) {
    ...
    (e.prototype.initZoomForTarget = function (e) {
      ...
      if (
        (t(e).each(function (e, a) {
          if (t(a).find("img").data("large_image_width") > i)
            return (o = !0), !1;
        }),
        o)
      ) {
    ...
    (e.prototype.initPhotoswipe = function () {
      this.zoom_enabled && this.$images.length > 0
        ? (this.$target.prepend(
            '<a href="#" role="button" class="woocommerce-product-gallery__trigger" aria-haspopup="dialog" aria-controls="photoswipe-fullscreen-dialog" aria-label="' +
