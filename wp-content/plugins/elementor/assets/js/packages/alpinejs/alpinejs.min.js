!(function () {
  ...
  function u(e) {
    let t = l.indexOf(e);
    -1 !== t && t > c && l.splice(t, 1);
  }
  function p() {
    (s = !1), (a = !0);
    for (let e = 0; e < l.length; e++) l[e](), (c = e);
    (l.length = 0), (c = -1), (a = !1);
  }
  var f = !0;
  function d(e) {
  ...
  function A() {
    !(function () {
      let e = w.takeRecords();
      k.push(() => e.length > 0 && R(e));
      let t = k.length;
      queueMicrotask(() => {
        if (k.length === t) for (; k.length > 0; ) k.shift()();
      });
    })(),
      w.disconnect(),
      (E = !1);
  ...
  function R(e) {
    ...
    for (let e of n) t.some((t) => t.contains(e)) || m.forEach((t) => t(e));
    for (let e of t) e.isConnected && g.forEach((t) => t(e));
  ...
  var U = {
    ...
    set({ objects: e }, t, n, i) {
      ...
      return o?.set && o?.get ? o.set.call(i, n) || !0 : Reflect.set(r, t, n);
    },
  };
  function I() {
  ...
  var Z = function (e, t) {
          ...
          : (function (e, t, n) {
              ...
              return (
                ...
                if ("function" == typeof i) {
                  let e = i.call(a, i, l).catch((e) => q(e, n, t));
                  i.finished
                    ? (Y(r, i.result, l, s, n), (i.result = void 0))
                    : e
                        .then((e) => {
                          Y(r, e, l, s, n);
                        })
    ...
    return G.bind(null, e, t, r);
  };
  function H(e, t) {
    return (
      n = () => {},
      { scope: i = {}, params: r = [], context: o } = {}
    ) => {
      Y(n, t.apply(j([i, ...e]), r));
    };
  }
  ...
  function Y(e, t, n, i, r) {
    if (W && "function" == typeof t) {
      let o = t.apply(n, i);
      o instanceof Promise
        ? o.then((t) => Y(e, t, n, i)).catch((e) => q(e, r, t))
        : e(o);
    } else
  ...
  function ue(e = () => {}) {
    return ({ name: t, value: n }) => {
      let { name: i, value: r } = pe.reduce((e, t) => t(e), {
        name: t,
        value: n,
      });
  ...
  function ge(e, t) {
    let n = -1 === me.indexOf(e.type) ? _e : e.type,
      i = -1 === me.indexOf(t.type) ? _e : t.type;
  ...
  function ve(e, t) {
    ...
    for (; i; ) ve(i, t), (i = i.nextElementSibling);
  }
  function ye(e, ...t) {
  ...
  function Se(e, t = !1) {
    return Ne(e, (e) => {
      if ((t ? Ae() : Oe()).some((t) => e.matches(t))) return !0;
    });
  }
  function Ne(e, t) {
    if (e) {
  ...
  function Pe(e, t = ve, n = () => {}) {
    Ne(e, (e) => e._x_ignore) ||
      (function () {
        ...
        (ae = i), se.set(i, []);
        let r = () => {
          for (; se.get(i).length; ) se.get(i).shift()();
          se.delete(i);
        };
        t(e, (e, t) => {
          e._x_marker ||
  ...
  function $e(e, t = ve) {
    t(e, (e) => {
      !(function (e) {
        for (e._x_effects?.forEach(u); e._x_cleanups?.length; )
          e._x_cleanups.pop()();
      })(e),
        b(e),
        delete e._x_marker;
          ...
          (i && "boolean" != typeof i
            ...
            : (function (e, t, n) {
                ...
                let s = !t.includes("opacity") && !t.includes("scale"),
                  a = s || t.includes("opacity") ? 0 : 1,
                  l = s || t.includes("scale") ? We(t, "scale", 95) / 100 : 1,
                  c = We(t, "delay", 0) / 1e3,
                  u = We(t, "origin", "center"),
                  p = "opacity, transform",
                  f = We(t, "duration", 150) / 1e3,
                  d = We(t, "duration", 75) / 1e3,
        ...
        !(function (e, t) {
          if (st(e))
            void 0 === e.attributes.value && (e.value = t),
              window.fromModel &&
                (e.checked =
                  "boolean" == typeof t ? tt(e.value) === t : et(e.value, t));
          else if (ot(e))
            Number.isInteger(t)
              ? (e.value = t)
              : Array.isArray(t) ||
  ...
  function ct({ get: e, set: t }, { get: n, set: o }) {
    let s,
      a,
      l = !0,
      c = i(() => {
        ...
        if (l) o(ut(i)), (l = !1);
          ...
          let e = JSON.stringify(i),
            n = JSON.stringify(r);
          e !== s ? o(ut(i)) : e !== n && t(ut(r));
        }
        (s = JSON.stringify(e())), (a = JSON.stringify(n()));
      });
    return () => {
      r(c);
    };
  ...
  var _t = {},
    mt = {
      ...
      extractProp: function (e, t, n, i = !0) {
        ...
        if (e._x_inlineBindings && void 0 !== e._x_inlineBindings[t]) {
          ...
          return (n.extract = i), V(() => K(e, n.expression));
        }
        return rt(e, t, n);
      },
      findClosest: Ne,
      ...
      magic: D,
      store: function (e, t) {
        if ((ft || ((pt = n(pt)), (ft = !0)), void 0 === t)) return pt[e];
        (pt[e] = t),
          L(pt[e]),
          "object" == typeof t &&
            null !== t &&
      ...
      start: function () {
        ...
        be &&
          ...
          Array.from(document.querySelectorAll(Ae().join(",")))
          ...
          setTimeout(() => {
            [
              ...
              var i;
              (i = t),
                Object.keys(te).includes(i) ||
                  n.some((t) => {
                    if (document.querySelector(t))
                      return ye(`found "${t}", but missing ${e} plugin`), !0;
                  });
            });
          });
      },
      ...
      bind: function (e, t) {
        ...
        return e instanceof Element ? ht(e, n()) : ((dt[e] = n), () => {});
      },
    },
    gt = class {
      constructor(e, t, n, i) {
    ...
    xt = class {
      ...
      tokenize() {
        ...
        return (
          this.tokens.push(new gt("EOF", null, this.position, this.position)),
          this.tokens
        );
      }
      skipWhitespace() {
      ...
      readNumber() {
        ...
        for (; this.position < this.input.length; ) {
          const e = this.input[this.position];
          if (this.isDigit(e)) this.position++;
          else {
            if ("." !== e || t) break;
            (t = !0), this.position++;
          }
        ...
        this.tokens.push(new gt("NUMBER", parseFloat(n), e, this.position));
      }
      readIdentifierOrKeyword() {
        ...
        [
          ...
          ? "true" === t || "false" === t
            ? this.tokens.push(
                new gt("BOOLEAN", "true" === t, e, this.position)
              )
            : "null" === t
            ? this.tokens.push(new gt("NULL", null, e, this.position))
            : "undefined" === t
            ? this.tokens.push(new gt("UNDEFINED", void 0, e, this.position))
            : this.tokens.push(new gt("KEYWORD", t, e, this.position))
          : this.tokens.push(new gt("IDENTIFIER", t, e, this.position));
      }
      readString() {
        const e = this.position,
        ...
        for (; this.position < this.input.length; ) {
          ...
          if (i) {
            ...
            if (r === t)
              return (
                this.position++,
                void this.tokens.push(new gt("STRING", n, e, this.position))
              );
            n += r;
          }
          this.position++;
      ...
      readOperatorOrPunctuation() {
        ...
        if ("=" === t && "=" === n && "=" === i)
          (this.position += 3),
            this.tokens.push(new gt("OPERATOR", "===", e, this.position));
        else if ("!" === t && "=" === n && "=" === i)
          (this.position += 3),
            this.tokens.push(new gt("OPERATOR", "!==", e, this.position));
        else if ("=" === t && "=" === n)
          ...
          this.position++;
          const n = "()[]{},.;:?".includes(t) ? "PUNCTUATION" : "OPERATOR";
          this.tokens.push(new gt(n, t, e, this.position));
        }
      }
    },
    vt = class {
      ...
      parseAssignment() {
        ...
        if (this.match("OPERATOR", "=")) {
          ...
          if ("Identifier" === e.type || "MemberExpression" === e.type)
            return {
        ...
        for (let t = 0; t < e.length; t++) {
          ...
          if (0 === t && e.length > 1) {
            ...
            for (let n = 1; n < e.length; n++)
              if (this.check(t, e[n])) return this.advance(), !0;
            return !1;
          }
          if (1 === e.length)
            return !!this.checkType(n) && (this.advance(), !0);
        }
        return !1;
      }
      check(e, t) {
      ...
      checkType(e) {
        return !this.isAtEnd() && this.current().type === e;
      }
      advance() {
        return this.isAtEnd() || this.position++, this.previous();
      }
      isAtEnd() {
        return "EOF" === this.current().type;
      }
      current() {
      ...
      consume(e, t) {
        if (void 0 !== t) {
          ...
          throw new Error(
            `Expected ${e} "${t}" but got ${this.current().type} "${
              this.current().value
            }"`
          );
        }
        ...
        throw new Error(
          `Expected ${e} but got ${this.current().type} "${
            this.current().value
          }"`
        );
      }
    ...
    yt = class {
      evaluate({
        ...
        context: n = null,
        allowGlobal: i = !1,
        forceBindingRootScopeToFunctions: r = !0,
      }) {
        switch (e.type) {
          case "Literal":
            return e.value;
          case "Identifier":
            ...
            if (i && void 0 !== globalThis[e.name]) {
              const t = globalThis[e.name];
              return "function" == typeof t ? t.bind(globalThis) : t;
            }
          ...
          case "MemberExpression":
            const o = this.evaluate({
              ...
              context: n,
              allowGlobal: i,
              forceBindingRootScopeToFunctions: r,
            });
            if (null == o)
            ...
            return (
              (s = e.computed
                ...
                : o[e.property.name]),
              "function" == typeof s ? (r ? s.bind(t) : s.bind(o)) : s
            );
          case "CallExpression":
            const a = e.arguments.map((e) =>
              this.evaluate({
                node: e,
                scope: t,
                context: n,
            ...
            if ("Identifier" === e.callee.type) {
              ...
              if (r in t) o = t[r];
                ...
                if (!i || void 0 === globalThis[r])
                  throw new Error(`Undefined variable: ${r}`);
                o = globalThis[r];
              }
          ...
          case "UpdateExpression":
            if ("Identifier" === e.argument.type) {
              const n = e.argument.name;
              if (!(n in t)) throw new Error(`Undefined variable: ${n}`);
              const i = t[n];
              return (
                "++" === e.operator
                  ? (t[n] = i + 1)
            ...
            if ("MemberExpression" === e.argument.type) {
              const o = this.evaluate({
          ...
          case "AssignmentExpression":
            ...
            if ("Identifier" === e.left.type) return (t[e.left.name] = p), p;
            if ("MemberExpression" === e.left.type) {
              const o = this.evaluate({
                node: e.left.object,
                scope: t,
                context: n,
              ...
              return (
                e.left.computed
                  ...
                  : (o[e.left.property.name] = p),
                p
              );
            }
            throw new Error("Invalid assignment target");
          case "ArrayExpression":
            return e.elements.map((e) =>
              this.evaluate({
                node: e,
                scope: t,
                context: n,
  ...
  var wt,
    Et = Object.freeze({}),
    Ot = (Object.freeze([]), Object.prototype.hasOwnProperty),
    At = (e, t) => Ot.call(e, t),
    kt = Array.isArray,
    Tt = (e) => "[object Map]" === Ct(e),
    St = (e) => "symbol" == typeof e,
    Nt = (e) => null !== e && "object" == typeof e,
    ...
    Ut = /-(\w)/g,
    It =
      (jt((e) => e.replace(Ut, (e, t) => (t ? t.toUpperCase() : ""))),
      /\B([A-Z])/g),
    Lt =
      (jt((e) => e.replace(It, "-$1").toLowerCase()),
  ...
  function Jt(e, t, n) {
    if (!Wt || void 0 === wt) return;
    let i = Bt.get(e);
    i || Bt.set(e, (i = new Map()));
    let r = i.get(n);
    r || i.set(n, (r = new Set())),
      r.has(wt) ||
        (r.add(wt),
        wt.deps.push(r),
        wt.options.onTrack &&
          wt.options.onTrack({ effect: wt, target: e, type: t, key: n }));
  }
    ...
    if ("clear" === t) s.forEach(l);
      ...
      switch ((void 0 !== n && l(s.get(n)), t)) {
        case "add":
          kt(e)
            ? $t(n) && l(s.get("length"))
            : (l(s.get(Dt)), Tt(e) && l(s.get(zt)));
          break;
        case "delete":
          kt(e) || (l(s.get(Dt)), Tt(e) && l(s.get(zt)));
          break;
        case "set":
          Tt(e) && l(s.get(Dt));
      }
  ...
  var Ht = bt("__proto__,__v_isRef,__isVue"),
    Xt = new Set(
  ...
  function nn(e = !1, t = !1) {
    return function (n, i, r) {
      ...
      if ("__v_raw" === i && r === (e ? (t ? $n : Pn) : t ? Cn : Rn).get(n))
        return n;
      const o = kt(n);
      if (!e && o && At(en, i)) return Reflect.get(en, i, r);
      const s = Reflect.get(n, i, r);
      return (St(i) ? Xt.has(i) : Ht(i))
        ? s
        : (e || Jt(n, "get", i),
          t
            ? s
  ...
  function rn(e = !1) {
    return function (t, n, i, r) {
      let o = t[n];
      if (!e && ((i = Ln(i)), (o = Ln(o)), !kt(t) && Mn(o) && !Mn(i)))
        return (o.value = i), !0;
      const s = kt(t) && $t(n) ? Number(n) < t.length : At(t, n),
        a = Reflect.set(t, n, i, r);
      return (
        t === Ln(r) &&
          (s ? Mt(i, o) && Zt(t, "set", n, i, o) : Zt(t, "add", n, i)),
        a
      );
    };
  }
  var on = {
      ...
      has: function (e, t) {
        ...
        return (St(t) && Xt.has(t)) || Jt(e, "has", t), n;
      },
      ownKeys: function (e) {
        return Jt(e, "iterate", kt(e) ? "length" : Dt), Reflect.ownKeys(e);
      },
    },
    sn = {
      get: Qt,
  ...
  function dn(e, t = !1) {
    return (
      (e = e.__v_raw), !t && Jt(Ln(e), "iterate", Dt), Reflect.get(e, "size", e)
    );
  }
  function hn(e) {
    e = Ln(e);
    const t = Ln(this);
    return un(t).has.call(t, e) || (t.add(e), Zt(t, "add", e, e)), this;
  }
  function _n(e, t) {
    t = Ln(t);
    const n = Ln(this),
      { has: i, get: r } = un(n);
    let o = i.call(n, e);
    o ? Nn(n, i, e) : ((e = Ln(e)), (o = i.call(n, e)));
    const s = r.call(n, e);
    return (
      n.set(e, t),
      o ? Mt(t, s) && Zt(n, "set", e, t, s) : Zt(n, "add", e, t),
      this
    );
  }
  function mn(e) {
    const t = Ln(this),
      { has: n, get: i } = un(t);
    let r = n.call(t, e);
    r ? Nn(t, n, e) : ((e = Ln(e)), (r = n.call(t, e)));
    const o = i ? i.call(t, e) : void 0,
      s = t.delete(e);
    return r && Zt(t, "delete", e, void 0, o), s;
  }
  function gn() {
    const e = Ln(this),
      t = 0 !== e.size,
      n = Tt(e) ? new Map(e) : new Set(e),
      i = e.clear();
  ...
  function kn(e, t) {
    ...
    return (t, i, r) =>
      "__v_isReactive" === i
        ...
        : "__v_raw" === i
        ? t
        : Reflect.get(At(n, i) && i in t ? n : t, i, r);
  }
  var Tn = { get: kn(!1, !1) },
    Sn = { get: kn(!0, !1) };
  function Nn(e, t, n) {
  ...
  var Rn = new WeakMap(),
    ...
    $n = new WeakMap();
  function jn(e) {
    return e && e.__v_isReadonly ? e : In(e, !1, on, Tn, Rn);
  }
  function Un(e) {
    return In(e, !0, sn, Sn, Pn);
  }
  ...
  D("nextTick", () => Ie),
    D("dispatch", (e) => xe.bind(xe, e)),
    D("watch", (e, { evaluateLater: t, cleanup: n }) => (e, i) => {
      let r = t(e),
        o = h(() => {
          let e;
          return r((t) => (e = t)), e;
  ...
  D(
    ...
    ne("teleport", (e, { modifiers: t, expression: n }, { cleanup: i }) => {
      ...
      ((function (e) {
        ...
        (o = a(o, (e, t) => {
          (function (e, t) {
            ...
            if (1 === n.length && Jn(e.key).includes(n[0])) return !1;
            ...
            if (
              ...
              if (Kn(e.type)) return !1;
              if (Jn(e.key).includes(n[0])) return !1;
            }
            return !0;
          })(t, n) || e(t);
        })),
  ...
  (qn.inline = (e, { modifiers: t }, { cleanup: n }) => {
    ...
    ne(
      ...
      (e, { modifiers: t, expression: n }, { effect: i, cleanup: r }) => {
        ...
        let l = () => {
            let e;
            return a((t) => (e = t)), Xn(e) ? e.get() : e;
          },
          c = (e) => {
            let t;
            a((e) => (t = e)),
              Xn(t) ? t.set(e) : s(() => {}, { scope: { __placeholder: e } });
          };
        "string" == typeof n &&
          "radio" === e.type &&
          T(() => {
        ...
        if (
          ...
          let n = Wn(e.form, "reset", [], (n) => {
            Ie(
              () => e._x_model && e._x_model.set(Zn(e, t, { target: e }, l()))
            );
          });
          r(() => n());
        }
    ...
    ne("cloak", (e) =>
      queueMicrotask(() => T(() => e.removeAttribute(ee("cloak"))))
    ),
    Te(() => `[${ee("init")}]`),
    ne(
      "init",
  ...
  (Yn.inline = (e, { value: t, modifiers: n, expression: i }) => {
    t &&
    ...
    ne("bind", Yn),
    ke(() => `[${ee("data")}]`),
    ne("data", (e, { expression: t }, { cleanup: i }) => {
      if (
        (function (e) {
          return !!Ve && (!!He || e.hasAttribute("data-has-alpine-state"));
        })(e)
      )
        return;
      t = "" === t ? "{}" : t;
      ...
      let l = K(e, t, { scope: o });
      (void 0 !== l && !0 !== l) || (l = {}), z(l, e);
      let c = n(l);
      L(c);
      let u = P(e, c);
      c.init && K(e, c.init),
        i(() => {
          c.destroy && K(e, c.destroy), u();
        });
    }),
    Ze((e, t) => {
      e._x_dataStack &&
    ...
    ne("for", (e, { expression: t }, { effect: i, cleanup: r }) => {
      let o = (function (e) {
          let t = /,([^,\}\]]*)(?:,([^,\}\]]*))?$/,
          ...
          (function (e, t, i, r) {
            ...
            i((i) => {
              ...
              let a = e._x_lookup,
                ...
                c = [],
                u = [];
              if ("object" != typeof (p = i) || Array.isArray(p))
                for (let n = 0; n < i.length; n++) {
                  let o = Qn(t, i[n], n, i);
                  r(
                    (t) => {
                      u.includes(t) && ye("Duplicate key on x-for", e),
                        u.push(t);
                    },
                    { scope: { index: n, ...o } }
                  ),
              ...
              for (let e = 0; e < u.length; e++) {
                let t = u[e],
                  n = l.indexOf(t);
                if (-1 === n) l.splice(e, 0, t), f.push([m, e]);
                else if (n !== e) {
                  let t = l.splice(e, 1)[0],
                    i = l.splice(n - 1, 1)[0];
                  l.splice(e, 0, i), l.splice(n, 0, t), d.push([t, i]);
                } else _.push(t);
                m = t;
              }
              ...
              for (let e = 0; e < d.length; e++) {
                ...
                T(() => {
                  r || ye('x-for ":key" is undefined or invalid', o, n, a),
                    r.after(s),
                    i.after(r),
              ...
              for (let e = 0; e < _.length; e++)
                a[_[e]]._x_refreshXForScope(c[u.indexOf(_[e])]);
              o._x_prevKeys = u;
            });
          })(e, o, s, a)
        ),
    ...
    ne("if", (e, { expression: t }, { effect: n, cleanup: i }) => {
      "template" !== e.tagName.toLowerCase() &&
        ye("x-if can only be used on a <template> tag", e);
      let r = J(e, t);
      n(() =>
        r((t) => {
          t
    ...
    ne(
      "on",
      Ke((e, { value: t, modifiers: n, expression: i }, { cleanup: r }) => {
        let o = i ? J(e, i) : () => {};
        "template" === e.tagName.toLowerCase() &&
    ...
    ti("Focus", "trap", "focus"),
    ti("Mask", "mask", "mask"),
    mt.setEvaluator(function (e, t) {
      let n = (function (e) {
        let t = {};
        return z(t, e), [t, ...$(e)];
      })(e);
      if ("function" == typeof t) return H(n, t);
      let i = (function (e, t, n) {
        return (e = () => {}, { scope: i = {}, params: r = [] } = {}) => {
          let o = j([i, ...n]),
            s = (function (e) {
              try {
                const t = new xt(e).tokenize(),
                  n = new vt(t).parse(),
                  i = new yt();
                return function (e = {}) {
                  const {
                    ...
                    context: r = null,
                    allowGlobal: o = !1,
                    forceBindingRootScopeToFunctions: s = !1,
                  } = e;
                  return i.evaluate({
                    node: n,
                    scope: t,
                    context: r,
                    allowGlobal: o,
                    forceBindingRootScopeToFunctions: s,
                  });
                };
              } catch (e) {
          ...
          if (W && "function" == typeof a) {
            let t = a.apply(a, r);
            t instanceof Promise ? t.then((t) => e(t)) : e(t);
          } else
    ...
    mt.setReactivityEngine({
        ...
        const n = (function (e, t) {
          const n = function () {
            ...
            if (!Ft.includes(n)) {
              qt(n);
              try {
                return Vt.push(Wt), (Wt = !0), Ft.push(n), (wt = n), e();
              } finally {
                Ft.pop(), Kt(), (wt = Ft[Ft.length - 1]);
              }
            }
          };
          return (
      ...
      release: function (e) {
        e.active &&
          (qt(e), e.options.onStop && e.options.onStop(), (e.active = !1));
      },
      raw: Ln,
    });
  var ni = mt;
  ...
  const ri = (e) => {
    ni.nextTick(() => {
      ni.destroyTree(e), ni.initTree(e);
    });
  };
  (window.elementorV2 = window.elementorV2 || {}).alpinejs = t;
})(),
