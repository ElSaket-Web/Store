...
"undefined" == typeof console && (window.console = { log: function () {} }),
  (function () {
    var r,
      a = gtm4wp_scrollerscript_debugmode,
    ...
    function n() {
      var e,
        t = window.innerHeight + window.scrollY,
        o = document.body.offsetHeight,
        n = 0;
      l < t &&
        !i &&
        ((n = new Date().getTime()),
        (e = Math.round((n - m) / 1e3)),
        a
          ? console.log("Started reading " + e)
        ...
        (e = document.querySelector(
          ...
          a
            ? console.log("End content section " + e)
            : window[gtm4wp_datalayer_name].push({
